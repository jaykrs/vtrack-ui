    ...
    return (
      <View style={styles.MainView}>
        <View style={styles.NestedView}>
          ...
          {/* <TouchableOpacity onPress={() => { navigate("Profile", { pid: Number(data.id) }) }}> */}
            <ImageBackground
              style={styles.header} borderRadius={80}
              source={{ uri: AppConstants.IMAGE_BASE_URL + '/avatar/' + data.id + '_avatar.png' }}
            />
          {/* </TouchableOpacity> */}
          <Text style={styles.displayName}>{data.firstName}</Text>
        </View>
      </View>
    )
  };
